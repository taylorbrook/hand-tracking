        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 879.0, 710.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 952.0, 81.0, 687.0, 623.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 0.0, 0.0, 800.0, 600.0 ],
                    "rendermode": 2,
                    "url": "file://handtracking.html"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 952.0, 12.0, 58.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 952.0, 42.0, 146.0, 22.0 ],
                    "text": "readfile handtracking.html"
                }
            },
            {
                "box": {
                    ...
                    "text": "0 Right 20 0.6225 0.4594 -0.0397"
                }
            },
            {
                "box": {
